...
export default function Register2() {
  return (
    ...
    <div data-testid="update" className="container-fluid">
  ...
  <h1>
          ...
          <p>Please enter your updated personal information for account creation.</p>
    ...
    <hr className="dropdown-divider"/>
          ...
          <p>Already have an account?<a className="nav-link active"aria-current="page" href="/">Sign In</a></p>
          {/* <a className="nav-link active"aria-current="page" href="/">Sign In</a> */}
          {/* <li className="nav-item"> */}
            {/* <a className="nav-link active"aria-current="page" href="/">Sign In</a> */}
          {/* </li> */}
